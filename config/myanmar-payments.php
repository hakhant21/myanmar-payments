...
return [
    ...
    'providers' => [
        '2c2p' => [
            ...
            'notify_url' => env('TWOC2P_REFUND_NOTIFY_URL', ''),
            'idempotency_id' => env('TWOC2P_REFUND_IDEMPOTENCY_ID', ''),
            'endpoints' => [
        ...
        'aya' => [
            'basic_token' => env('AYA_BASIC_TOKEN', ''),
            'phone' => env('AYA_PHONE', ''),
            'password' => env('AYA_PASSWORD', ''),
            'service_code' => env('AYA_SERVICE_CODE', ''),
            'time_limit' => env('AYA_TIME_LIMIT'),
            'endpoints' => [
                'login' => env('AYA_LOGIN_URL', 'https://opensandbox.ayainnovation.com/merchant/1.0.0/thirdparty/merchant/login'),
                'push_payment' => env('AYA_PUSH_PAYMENT_URL', 'https://opensandbox.ayainnovation.com/merchant/1.0.0/thirdparty/merchant/requestPushPayment'),
                'push_payment_v2' => env('AYA_PUSH_PAYMENT_V2_URL', 'https://opensandbox.ayainnovation.com/merchant/1.0.0/thirdparty/merchant/v2/requestPushPayment'),
                'query_payment' => env('AYA_QUERY_PAYMENT_URL', 'https://opensandbox.ayainnovation.com/merchant/1.0.0/thirdparty/merchant/checkRequestPayment'),
                'qr_payment' => env('AYA_QR_PAYMENT_URL', 'https://opensandbox.ayainnovation.com/merchant/1.0.0/thirdparty/merchant/requestQRPayment'),
                'refund_payment' => env('AYA_REFUND_PAYMENT_URL', 'https://opensandbox.ayainnovation.com/merchant/1.0.0/thirdparty/merchant/refundPayment'),
            ],
            'timeout' => (int) env('AYA_TIMEOUT', 30),
        ],
        'wavemoney' => [
        ...
        'kbzpay' => [
            ...
            'client_certificate_path' => env('KBZPAY_CLIENT_CERTIFICATE_PATH', ''),
            'client_certificate_key_path' => env('KBZPAY_CLIENT_CERTIFICATE_KEY_PATH', ''),
            'client_certificate_key_passphrase' => env('KBZPAY_CLIENT_CERTIFICATE_KEY_PASSPHRASE', ''),
